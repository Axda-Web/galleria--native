...
const EAS_PROJECT_ID = "5725341e-a7f6-4dca-9fc2-e9204de2ed70";
const PROJECT_SLUG = "galleria";
const OWNER = "axda-studio";

// App production config
const APP_NAME = "galleria.";
const BUNDLE_IDENTIFIER = "com.axdastudio.galleria";
const PACKAGE_NAME = "com.axdastudio.galleria";
